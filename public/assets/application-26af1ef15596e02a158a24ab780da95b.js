  ...
  main = {
    ...
    presentMoneySlider: function() {
      ...
      if (money_image.hasClass('hide')) {
        ...
        return money_label.removeClass('skills');
      } else {
        present_image.show();
        ...
        return present_label.removeClass('skills');
      }
    },
    presentMoneySliderScheduler: function() {
      var test;
      test = function() {
        return main.presentMoneySlider();
      };
      return setInterval(test, 3 * 1000);
    }
  };
